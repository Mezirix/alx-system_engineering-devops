...
approximately 23:07 Pacific Standard Time (PST), an outage occurred on an isolated
...
address it, roughly 20:20 PST. He promptly proceeded to undergo solving the problem.
...
But of course, it will never occur again, because we're software engineers, and we never make
errors! :wink: :smile:
